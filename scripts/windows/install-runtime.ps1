...
$grokModel = if ($env:SPARK_GROK_MODEL) { $env:SPARK_GROK_MODEL } elseif ($existing["SPARK_GROK_MODEL"]) { $existing["SPARK_GROK_MODEL"] } else { "@cf/meta/llama-3.3-70b-instruct-fp8-fast" }
