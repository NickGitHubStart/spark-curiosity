...
export interface MemorySnapshot {
  ...
  longTermGoals: Array<{ name: string; confidence: number; lastSeen: string }>;
  midTermPatterns: Array<{ pattern: string; confidence: number; lastSeen: string }>;
  motivationalMedia?: Array<{ title: string; url: string; confidence: number; lastSeen: string }>;
  shortTermState: {
    activeIntent?: string;
